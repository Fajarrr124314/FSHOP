<div class="astro-bot-container">
    ...
    <div class="chat-box-window glass-card {{ $isOpen ? 'show' : '' }}">
        ...
        <div style="padding: 0.4rem 0.8rem; display: flex; gap: 0.4rem; overflow-x: auto; background: rgba(0,0,0,0.1);">
            ...
            <button type="button" style="padding: 0.2rem 0.6rem; border-radius: 12px; background: var(--bg-card); border: 1px solid var(--border-color); color: var(--text-secondary); font-size: 0.75rem; white-space: nowrap; cursor: pointer;" wire:click="sendMessage('Bisa bantu jasa tugas?')">Jasa Tugas?</button>
        </div>
